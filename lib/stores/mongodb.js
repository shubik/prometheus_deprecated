var mongo          = require('mongodb'),
    ...
    mongo_server   = mongo.Server(config.mongodb.host, config.mongodb.port, {}),
    mongo_database = new mongo.Db(config.mongodb.database, mongo_server, { w: 1 }),
    def            = deferred(),
