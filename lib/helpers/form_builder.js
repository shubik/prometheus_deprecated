...
var FormBuilder = function(schema, data, options) {
        ...
        make = {
            ...
            */
            ...
            text: function(obj) {
                ...
                } else if (obj.attr === 'email') {
                    type = 'email';
                } else if (obj.attr === 'phone' || obj.attr === 'fax') {
                    type = 'tel';
                } else if (obj.attr === 'url') {
                    type = 'url';
                } else if (_.isNumber(obj.val)) {
                    type = 'number';
                } else if (_.isDate(obj.val)) {
                    type = 'date';
                } else {
                    type = 'text';
                }
    ...
    _.each(schema, function(obj, attr) {
        ...
        } else if (obj.multiline || (obj.maxlength && obj.maxlength > 255)) {
            field.type = 'textarea';
