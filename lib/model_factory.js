        ...
        */
        ...
        validate: function() {
            ...
            valid = _.reduce(this._schema, function(memo, val, attr) {
                ...
                if (val.required || val.type === indextypes.UNIQUE || val.type === indextypes.PRIMARY) {
                    if (attr_val === val.default || attr_val === '' || attr_val === null) {
                        pass = false;
                    }
                    ...
                    if (!pass) {
                        console.log('validate() fail required:', attr, typeof attr_val, attr_val, val);
                    }
                }
