...
ModelFactory = function(options) {
    ...
    */
    ...
    var ModelConstructor = function(query, options) {
        ...
        // here goes logic of Object Pool Pattern - with this._inuse
    ...
    _.extend(ModelConstructor.prototype, {
        ...
        */
        ...
        /**
        Explicitly prepares JS model instance for garbage collection
        @method gc
        */
        ...
        gc: function() {
            ...
            /* --- Change __proto__ to an empty object --- */
