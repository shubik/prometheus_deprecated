...
ModelFactory = function(options) {
    ...
    */
    ...
    /*
    _.each(mixins, function(mixin) {
        _.extend(ModelConstructor.prototype, mixin.methods || {});
    });
    */
    ...
    _.extend(ModelConstructor.prototype, events, {
        ...
        */
        ...
        _cache_permissions: function(model_data) {
            ...
            Store these values in this._is_allowed.create, this._is_allowed.read etc.
            */
            ...
            deferred.map(roles, function(role) {
                ...
                _.each(results, function(result) {
                    _.extend(self._is_allowed, result);
                });

                console.log('_is_allowed', self._is_allowed);
            });
        ...
        */
        ...
        load: function(query) {
            ...
            this._store.findOne(query)(function(model_data) {
                self._cache_permissions(model_data)(function() {
                    if (model_data === null) {
                        self._attributes = null;
                        //self._loading.resolve(null);
                    } else {
                        self._attributes = (self._store.parse) ? self._store.parse(model_data) : model_data;
            ...
            this._ready(function() {
                ...
                if (self.validate()) {
                    ...
                    if (self._isnew) {
                        ...
                        /*
                        if (!self._cache_permissions('create')) {
                            return def.resolve(new error.Unauthorized('You do not have privileges to create new record'));
                        }
                        */
                        ...
                        /*
                        if (!self._cache_permissions('update')) {
                            return def.resolve(new error.Unauthorized('You do not have privileges to update this record'));
                        }
                        */
        ...
        */
        ...
        destroy: function() {
            ...
            this._ready(function() {
                ...
                /*
                if (!self._cache_permissions('destroy')) {
                    return def.resolve(new error.Unauthorized('You do not have privileges to delete this record'));
                }
                */
        ...
        */
        ...
        toJSON: function(key) {
            /*
            if (!this._cache_permissions('read')) {
                throw new error.Unauthorized('You do not have privileges to read this record');
            }
            */
